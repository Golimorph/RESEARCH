...
Microcanonical::Microcanonical(Parameters *parameters, Crystal *crystal, Ewald *ewald , Eigen::VectorXd *spinOrientation)
:
...
Eigen::MatrixXd Microcanonical::run()
...
Eigen::MatrixXd Microcanonical::run(int myrank, int nproc)
...
Eigen::RowVector3d Microcanonical::Magnetization()
{
...
void Microcanonical::MCsimRun(unsigned long long int stepsPerBin)
...
double Microcanonical::singleSweepList()
{
    ...
    for(int N=0; N<Nspins; ++N)
    {
        ...
        */
        ...
        //Microcanonical--------------------------------------------------------------------------------------------------------
        if(de==0){//Accept only if energy is conserved
            dE+=de;
            Elist(i)= -Elist(i);//updating field and interaction energies for i.
...
double Microcanonical::loopSweepList()
...
/*************************************************************************************/
inline void Microcanonical::AddToCorrelationSiSj()
{
...
void Microcanonical::saveToFile(std::string path)
{
...
void Microcanonical::saveStateToFile(std::string path, int i)
{
...
/*****************************************************************************************************/
Eigen::MatrixXd Microcanonical::getSumCorrSiSj()
{
    return sumCorrSiSj;
}
...
/*****************************************************************************************************/
Eigen::MatrixXd Microcanonical::getData()
{
    return data;
}
